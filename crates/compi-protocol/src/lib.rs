//! Protocol v7 control and screen values. No engine, PTY, or platform dependencies.
pub mod frame;
mod screen;

pub use screen::{
    Cell, Color, CursorShape, CursorState, KittyImage, KittyPlacement, MouseMode, Row, RowUpdate,
    ScreenDelta, ScreenMessage, ScreenSnapshot, TerminalModes, TextAttributes, decode_screen,
    encode_screen,
};
