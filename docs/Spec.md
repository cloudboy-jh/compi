...
- The bundled catalog contains 40 complete whole-app themes (25 dark and 15 light), generated from validated data at build time. Dark/light filters, favorites, and miniature terminal/header previews support browsing. Imported palettes retain their licenses and attribution, accessible from the catalog.
